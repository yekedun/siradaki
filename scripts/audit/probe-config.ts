...
export const EDGE_FN_PROBES: EdgeFnProbeConfig[] = [
  ...
  { name: "appointment-reminder-push", expectedOptionsAllowedStatus: 204, expectedAnonStatus: 403, expectedNoAuthStatus: [401], expectedServiceStatus: 500, wrongMethodStatus: [401, 405], body: {} },
  ...
  { name: "save-push-subscription", expectedOptionsAllowedStatus: 204, expectedAnonStatus: 400, expectedNoAuthStatus: [401], expectedServiceStatus: 401, wrongMethodStatus: [401, 405], body: {} },
